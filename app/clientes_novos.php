...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Setando e requisitando endpoint
    $resultados = api_request('create_novo_cliente', 'POST', [
        'nome' => $_POST['nome'],
    ...
    // Lógica de msg de resultado da operação 
    ...
    <section class="container">
        <div class="row my-5">
            <div class="col-sm-6 offset-sm-3 card bg-light p-4">
                ...
                <form action="clientes_novos.php" method="POST">
